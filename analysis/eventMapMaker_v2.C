...
TH2F *normalisation(TH2F *histo, Int_t n){
...
void eventMapMaker(){
	...
	for (int i = 0; i < 16; ++i)
	{
		...
		hPiece_Rebin[i] = new TH2F(Form("hPiece_Step%d_rebin", i+1), ";x (mm);y (mm)", 10, -27.75, 27.75, 10, -27.75, 27.75);
	...
	// hResult->Add(hBackground, 1);

	// Factor
	Float_t factor[16][4] = {0};
	// Step1
	factor[0][0] = 1;
	factor[0][1] = 0.94;
	hPiece[0]->Add(getPiece(piece[1], factor[0][0]));
	hPiece[0]->Add(getPiece(piece[2], factor[0][1]));
	hResult->Add(getPiece(piece[1], factor[0][0]));
	hResult->Add(getPiece(piece[2], factor[0][1]));
	
	TCanvas *c_step1 =  new TCanvas("c_step1", "step1", 1500, 500);
	c_step1->Divide(3,1);
	c_step1->cd(1);
	normalisation(getPiece(piece[1], factor[0][0]))->Draw("colztext");
	c_step1->cd(2);
	normalisation(getPiece(piece[2], factor[0][1]))->Draw("colztext");
	c_step1->cd(3);
	hPiece_Rebin[0]->Add(normalisation(hPiece[0]), 1);
	hPiece_Rebin[0]->Draw("colztext");
	...
	factor[1][2] = 0.81*0.8;
	factor[1][3] = 0.62*0.8;
	hPiece[1]->Add(getPiece(piece[4], factor[1][0]));
	hPiece[1]->Add(getPiece(piece[5], factor[1][1]));
	hPiece[1]->Add(getPiece(piece[6], factor[1][2]));
	hPiece[1]->Add(getPiece(piece[7], factor[1][3]));
	hResult->Add(getPiece(piece[4], factor[1][0]));
	hResult->Add(getPiece(piece[5], factor[1][1]));
	hResult->Add(getPiece(piece[6], factor[1][2]));
	hResult->Add(getPiece(piece[7], factor[1][3]));
	...
	c_step2->cd(3);
	hPiece_Rebin[1]->Add(hPiece_Rebin[0], 1);
	hPiece_Rebin[1]->Add(normalisation(hPiece[1]), 1);
	hPiece_Rebin[1]->Draw("colztext");
	...
	factor[2][2] = 0.68*0.7;
	factor[2][3] = 0.56*0.7;
	hPiece[2]->Add(getPiece(piece[8], factor[2][0]));
	hPiece[2]->Add(getPiece(piece[9], factor[2][1]));
	hPiece[2]->Add(getPiece(piece[10], factor[2][2]));
	hPiece[2]->Add(getPiece(piece[11], factor[2][3]));
	hResult->Add(getPiece(piece[8], factor[2][0]));
	hResult->Add(getPiece(piece[9], factor[2][1]));
	hResult->Add(getPiece(piece[10], factor[2][2]));
	hResult->Add(getPiece(piece[11], factor[2][3]));
	...
	c_step3->cd(3);
	hPiece_Rebin[2]->Add(hPiece_Rebin[1], 1);
	hPiece_Rebin[2]->Add(normalisation(hPiece[2]), 1);
	hPiece_Rebin[2]->Draw("colztext");
	...
	factor[3][2] = 0.62*0.7;
	// factor[3][3] = 0.1;
	// hPiece[3]->Add(getPiece(piece[12], factor[3][0]));
	hPiece[3]->Add(getPiece(piece[13], factor[3][1]));
	hPiece[3]->Add(getPiece(piece[14], factor[3][2]));
	// hPiece[3]->Add(getPiece(piece[15], factor[3][3]));
	// hResult->Add(getPiece(piece[12], factor[3][0]));
	hResult->Add(getPiece(piece[13], factor[3][1]));
	hResult->Add(getPiece(piece[14], factor[3][2]));
	// hResult->Add(getPiece(piece[15], factor[3][3]));
	...
	c_step4->cd(3);
	hPiece_Rebin[3]->Add(hPiece_Rebin[2], 1);
	hPiece_Rebin[3]->Add(normalisation(hPiece[3]), 1);
	hPiece_Rebin[3]->Draw("colztext");

	// // Step5
	// factor[4][0] = 0.2;
	// factor[4][1] = 0.4;
	// hPiece[4]->Add(getPiece(piece[13], factor[4][0]));
	// hPiece[4]->Add(getPiece(piece[14], factor[4][1]));
	// hResult->Add(getPiece(piece[13], factor[4][0]));
	// hResult->Add(getPiece(piece[14], factor[4][1]));
	...
	// c_step5->cd(3);
	// hPiece_Rebin[4]->Add(hPiece_Rebin[3], 1);
	// hPiece_Rebin[4]->Add(normalisation(hPiece[4]), 1);
	// hPiece_Rebin[4]->Draw("colztext");


	// // Step6
	// factor[5][0] = 0.5;
	// hPiece[5]->Add(getPiece(piece[13], factor[5][0]));
	// hResult->Add(getPiece(piece[13], factor[5][0]));

	// TCanvas *c_step6 = defaultCanvas("step6");
	// c_step6->cd(1);
	// hPiece[4]->Draw("colztext");
	// c_step6->cd(2);
	// normalisation(getPiece(piece[13], factor[5][0]))->Draw("colztext");
	// c_step6->cd(3);
