...
void gen_macro_rec(int gui =1, int runAcc = 0){ 
  ...
  int event_map[10][10] = {  	
	{600,600,600,1200,1200,1200,1200,1200,1200,1200},
	{600,1200,1200,1800,1800,1800,1800,1800,1800,1800},
	{600,1200,1200,1800,3000,3000,3000,3000,3000,3000},
	{600,1200,1200,1800,3000,3000,3000,3000,3000,3000},
	{600,1200,1200,1800,3000,3000,6000,6000,3000,3000},
	{600,1200,1200,1800,3000,3000,6000,6000,3000,3000},
	{600,1200,1200,1800,3000,3000,3000,3000,3000,3000},
	{600,1200,1200,1800,3000,3000,3000,3000,3000,3000},
	{600,1200,1200,1800,1800,1800,1800,1800,1800,1800},
  ...
  for (int iX = 0; iX < maxBin; ++iX)
  {
  	for (int iY = 0; iY < maxBin; ++iY){
		...
		ofs << "#" << endl;
		ofs << Form("/run/beamOn %d", event_map[iX][iY]) << endl;  		
  	}
  }
  ofs.close();
